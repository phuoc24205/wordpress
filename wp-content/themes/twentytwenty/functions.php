...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array(
			'name'          => __( 'Footer Text Area', 'twentytwenty' ),
			'id'            => 'footer-text',
			'description'   => __( 'Widgets in this area will be displayed in the footer copyright area.', 'twentytwenty' ),
			'before_widget' => '<div class="footer-text-widget">',
			'after_widget'  => '</div>',
